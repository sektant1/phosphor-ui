...
export const Default: Story = {
  parameters: { docs: { source: { code: basicUsage.ContentEditor } } },
  args: {
    kindLabel: "POST",
    fields: [
...
export const Shell: StoryObj = {
  parameters: {
    docs: {
      source: {
        code: `import { EditorShell, Input } from "@sektant1/phosphor-ui";
...
export const FieldParts: StoryObj = {
  parameters: {
    docs: {
      source: {
        code: `import { PairListField, RepeaterField, StatusSelect, TagInput } from "@sektant1/phosphor-ui";

export function Example() {
  return (
    <>
      <StatusSelect value="draft" onChange={() => {}} />
      <TagInput value={["react"]} inputValue="" onInputChange={() => {}} onChange={() => {}} />
    </>
  );
}`,
      },
