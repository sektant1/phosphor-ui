        ...
        <DemoSplit className="pho-fade-up">
          ...
          >
            ...
            <p>
              ...
              <strong> γ-2 / SECTOR-7</strong>. First task: confirm the cathode
              is intact and the line voltage matches the local rail.
            </p>
...
> repeat`}</code>
            ...
            <Callout variant="warn" title="Hazard">
              Stored charge on the flyback transformer can persist for hours
              after power-down. Always discharge before contact.
            </Callout>
